...
const FeedbackPage = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            toast("FeedBack Submitted Successfully.Thank You");
            navigate("/");
            reset();
        } catch (error) {
            console.error("Error submitting complaint:", error);
            toast("Failed to submit complaint. Please try again.");
        }
    };
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-50">
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white  p-8 w-full">
                <h2 className="text-3xl font-bold text-center text-indigo-700 mb-8">Help Us Improve</h2>
                ...
                <div className="mb-6">
                    ...
                    />
                    {errors.feedback && <p className="text-red-500 text-sm mt-2">{errors.feedback.message}</p>}
                </div>
