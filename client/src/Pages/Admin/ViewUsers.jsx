...
const ViewUsers = () => {
    ...
    const handleBlockUnblock = async (userId, isBlocked) => {
        try {
            await axiosInstance.put(`/Admin/block-unblock/${userId}`);
    ...
    // Pagination logic
    const filteredUsers = users.filter((user) => user.username.toLowerCase().startsWith(searchTerm.toLowerCase()));
                    ...
                    <div className="bg-white p-6 rounded shadow-lg w-11/12 md:w-2/3 lg:w-1/2">
                        ...
                        {bankDetails ? (
                            <>
                                ...
                                <p>
                                    <strong>Status:</strong> {bankDetails.status}
                                </p>
                                <p>
